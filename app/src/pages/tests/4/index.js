...
const Example = () => {
    ...
    if (data) {
        const { product_w } = data
        const products = Object.entries(product_w).reverse()
        // console.log(Object.entries(product_w).reverse())
        return (
            <AppLayout
                header={
                                    ...
                                    <table className="min-w-full divide-y divide-gray-300">
                                        <thead className="bg-gray-100">
                                            <tr>
                                                ...
                                                <th
                                                    scope="col"
                                                    className="py-3.5  pr-3 text-left text-sm font-bold text-gray-900 ">
                                                    Продукт
                                                </th>
                                                <th
                                                    scope="col"
