...
const DeleteItemProduct = () => {
    ...
    return (
        ...
        <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={() => is_visible_delete_product(false)}>
            <Transition.Child
            as={Fragment}
            ...
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
                    ...
                    <button
                        ...
                        onClick={() => {
                            removeProduct({variables: { id: currentIDProduct }}),
                            is_visible_delete_product(false)
                        }}
                    >
                        Удалить
                    </button>
                    <button
                        ...
                        onClick={() => is_visible_delete_product(false)}
                        ref={cancelButtonRef}
                    >
                        Отменить
                    </button>
